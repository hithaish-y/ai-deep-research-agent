...
Guardian — Validates safety and length requirements. Tool: guardrail_node

Strategist — Maps the user request to a detailed plan. Tool: expert_planner_skill

Searcher — Generates search intent and scrapes sources. Tool: robust_search_skill

Synthesizer — Merges research into cited Markdown. Tool: report_writer_skill

Evaluator — Critiques for tone, accuracy, and flow. Tool: critique_skill
...
git clone https://github.com/hithaish-y/ai-deep-research-agent.git
...
DATABASE_URL: Optional connection string for PostgreSQL persistence.
...
2. Observation: The terminal will show planning logs, research queries, and draft generations.
...
Centralized Logging: Swapped generic prints for logging modules for production monitoring.

Cycle Tracking: Every report is tracked via a thread_id in the database, allowing audit trails of agent decisions.
...
SECURITY: Added Guardrail Node for PII and 5k character limits.
...
@software{Hithaish_Multi_Agent_2026,
  ...
  url = {https://github.com/hithaish-y/ai-deep-research-agent}
...
Hithaish Y — GitHub: https://github.com/hithaish-y

Project Link: https://github.com/hithaish-y/ai-deep-research-agent

Special thanks to the LangChain and Groq communities for